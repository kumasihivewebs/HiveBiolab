...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Manage website content, submissions, and training registrations",
    "copyright": "HiveBiolab © 2025 • Trusted Biotech",
    "order_with_respect_to": ["content", "training", "newsletter", "contact", "auth.User"],
    "hide_models": ["auth.Group"],
    "icons": {
        "content": "fas fa-layer-group",
        "content.Project": "fas fa-flask",
